...
namespace School
{
    ...
    partial void DeleteRegistration(Registration instance);
		...
		public SchoolDataContext() : 
				base(global::School.Properties.Settings.Default.SchoolDBConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnSubjectCreditsChanging(int value);
    partial void OnSubjectCreditsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SubjectCredits", DbType="Int NOT NULL")]
